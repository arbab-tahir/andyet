<template>
  <div>
    <div class="card text-center mContent border-0">
      <div class="card-header bg-white border-0 cHeader"></div>
      <div class="card-body border-0">
        <img
          class="logoImg"
          src="https://highseastudio.com/demo/coworking/multiple-pages/wp-content/uploads/2016/02/logo.png"
          alt="ABOUT OUR FRIENDLY COMMUNITY"
        />
        <h5 class="card-title cTitle">ABOUT OUR FRIENDLY COMMUNITY</h5>
        <div class="cText">
          <p class="card-text">
            Whether it’s working for yourself, or remotely, it’s great to be
            independent. Our purpose is to create an environment that allows you
            to focus on what’s really important, getting your work done and meet
            interesting people. All these in one place!
          </p>
        </div>
        <button type="button" class="btn learnMore">
          LEARN MORE
          <font-awesome-icon class="aIcon" icon="fa-solid fa-arrow-right" />
        </button>
      </div>
    </div>

    <div class="container-fluid contain text-center">
      <h5 class="card-title bTitle">BENEFITS</h5>
      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <p style="overflow-wrap: break-word">Private Phone Booth</p>
        </div>
        <div class="col">
          <i class="waIcon">
            <svg
        ...
        <div class="col">
          ...
          <p style="overflow-wrap: break-word">Modern Open Design</p>
        </div>
      </div>
      ...
      <div class="row sRow">
        <div class="col">
          ...
          <p style="overflow-wrap: break-word">Insanely Fast Internet</p>
        </div>
        <div class="col">
          <i class="waIcon">
            <svg
        ...
        <div class="col">
          ...
          <p style="overflow-wrap: break-word">Conference Rooms</p>
        </div>
        <div class="col">
          <i class="waIcon">
            <svg
    ...
    <div class="backContainer">
      <img
        class="bgImage"
        src="https://highseastudio.com/demo/coworking/multiple-pages/wp-content/uploads/2016/02/paralax.jpg"
        alt="Background Picture"
      />
      <div class="centered">
        <h1 class="pHeading">
          CREATIVE SPACE WILL HELP YOU FIND THE INSPIRATION
        </h1>
        <br />
      </div>
    </div>
    ...
    <div class="card text-center">
      <div class="card-header bg-white cHead border-0"></div>
      <div class="card-body border-0">
        <i>
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <h5 class="card-title cTitle">SUBSCRIBE TO OUR NEWSLETTER</h5>
        <form class="row g-3 subRow">
          <div class="col">
            <input
              type="text"
      ...
      <div class="card-footer bg-white cFooter border-0"></div>
    </div>
  </div>
</template>
...
.bgImage {
  background-image: url(https://highseastudio.com/demo/coworking/multiple-pages/wp-content/uploads/2016/02/paralax.jpg);
